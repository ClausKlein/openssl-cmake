...
if(MSVC)
    ...
    file(WRITE build/src/openssl/build-on-windows.bat "call ms/do_ms.bat && nmake -f ms/nt.mak || type ms/nt.mak")
    set(GENERATE_MAKE_FILES "cmd /C ./build-on-windows.bat")
